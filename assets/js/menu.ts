...
function createMenuElement() {
    ...
    menuItems.forEach(item => {
        const liElement = createElement('li', { 'class': 'menu-items' }),
            aElement = createElement('a', { "href": item.href }, item.nicename);
...
function createElement(type: string, attributes: Object = {}, innerHtml: string = "") {
